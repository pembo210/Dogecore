...
Block.getBlockValue = function getBlockValue(height) {
  var subsidy;
    if (height > 0 && height < 99999) { subsidy = (1000000 * 100000000);
    } else if (height > 100000 && height < 144999) { subsidy = (500000 * 100000000);
    } else if (height > 145000 && height < 199999) { subsidy = (250000 * 100000000);
    } else if (height > 200000 && height < 299999) { subsidy = (125000 * 100000000);
    } else if (height > 300000 && height < 399999) { subsidy = (62500 * 100000000);
    } else if (height > 400000 && height < 499999) { subsidy = (31250 * 100000000);
    } else if (height > 500000 && height < 599999) { subsidy = (15625 * 100000000);
    } else if (height > 600000 ) { subsidy = (10000 * 100000000);
    };
  return subsidy;
};
